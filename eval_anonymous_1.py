...
if __name__ == "__main__":
    ...
    pca_model = keras.models.load_model("./Models/Fine-Pruning-PCA-Approach/anonymous_1_fixed_net.h5")
    pur_model = keras.models.load_model("./Models/Fine-Pruning Approach/G2.h5")
