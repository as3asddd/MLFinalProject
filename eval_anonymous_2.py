...
if __name__ == "__main__":
    ...
    pca_model = keras.models.load_model("./Models/Fine-Pruning-PCA-Approach/anonymous_2_fixed_net.h5")
    pur_model = keras.models.load_model("./Models/Fine-Pruning Approach/G3.h5")
